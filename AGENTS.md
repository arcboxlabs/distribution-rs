...
OCI Distribution Registry 的 Rust 重写，目标通过 OCI Distribution Spec conformance test。Go 参考实现：`/Users/zhangbin/Arcbox/distribution/`，规划文档：`docs/overview.md`（含架构图、分阶段完成标准）。
